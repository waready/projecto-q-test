  ...
  <div class="q-pa-md row justify-center">
    <div style="" class="grid-t">
      ...
      <q-chat-message
        name=""
        avatar="../statics/images/avatars/2.jpg"
        :text="['Inasa nayaxa yaputuqiru sarchïya']"
        stamp=""
        sent
        bg-color="amber-7"
      />
      ...
      <q-btn round class="q-mt-md" color="primary" icon="volume_up" @click="open('bottom','semana7-1')" />
      </div>
      ...
      <div style="text-align:center" >
        <q-chat-message
          name=""
          avatar="../statics/images/avatars/2.jpg"
          :text="[`¿Kawkïri phuruta jumatakixa jukʼampi munasmaxa?`]"
          stamp=""
          sent
          bg-color="amber-7"
        />
        <q-chat-message
          name=""
          avatar="../statics/images/avatars/1.jpg"
          :text="[`Nayaxa manzanaraki walpunwa muntxa`]"
          stamp=""
          text-color="white"
          bg-color="primary"
        />
      ...
      <q-btn round class="q-mt-md" color="primary" icon="volume_up" @click="open('bottom','semana7-2')" />
      </div>
      ...
      <div style="text-align:center" >
        ...
        name=""
        avatar="../statics/images/avatars/2.jpg"
        :text="['¿Inasa jumaxa llawinakaxa uñjsta?']"
        stamp=""
        sent
        bg-color="amber-7"
      />
      ...
      <q-chat-message
        name=""
        avatar="../statics/images/avatars/2.jpg"
        :text="[`Nayaxa aphanakirakiwa jakiña muntxa`]"
        stamp=""
        sent
        bg-color="amber-7"
      />

      <q-btn round class="q-mt-md" color="primary" icon="volume_up" @click="open('bottom','semana7-3')" />
      </div>
