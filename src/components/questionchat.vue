    ...
    <div style="" class="grid-t">
      ...
      />
       <q-chat-message
        name=""
        avatar="../statics/images/avatars/2.jpg"
        :text="['Nayanxa Pedrorakiwa']"
        stamp=""
        sent
        bg-color="amber-7"
      />
      <q-btn round class="q-mt-md" color="primary" icon="volume_up" @click="open('bottom','semana2-1')" />
      </div>
      ...
      <q-chat-message
        ...
        bg-color="primary"
      />
      <q-btn round class="q-mt-md" color="primary" icon="volume_up" @click="open('bottom','semana2-2')" />
      </div>
      ...
      <q-chat-message
        name=""
        avatar="../statics/images/avatars/1.jpg"
        :text="['Nayaxa Puno markana utjtxa']"
        stamp=""
        text-color="white"
        bg-color="primary"
      />
      ...
      <q-btn round class="q-mt-md" color="primary" icon="volume_up" @click="open('bottom','semana2-3')" />
      </div>
